...
const Home = () => {
  ...
  <div>
    ...
    <NavLink to="/homme"><button className="btn-12"><span>Collection Homme &rarr;</span></button></NavLink> 
    <NavLink to="/femme"><button className="btn-12"><span>Collection Femme &rarr;</span></button></NavLink>   
    </div>
    <h1 className="content__title">Nouvelle Collection</h1>
    <h3 className="content__author">2023</h3>  
    <section>
    ...
    <div className='qui'>
      <div className='cont'>
        ...
        <p>Watch Brussels est une entreprise  spécialisée dans la vente de montres de luxe.
          Nous proposons une réduction allant de 50% à 70% du prix initial. Nous collaborons
          avec les fournisseurs des marques, ce qui nous permet de proposer des prix cassés à notre clientèle.
          Tous nos produits sont 100% authentiques et certifiés.
      </p>
      <h2>NOS SERVICES</h2>
        <p>Chaque montre est fournie avec :
          - Son certificat d'authenticité
          - Une facture
          - Une garantie de 2 ans sur le mécanisme à dater du jour de l'achat (voir conditions sur le certificat d'authenticité) 
      </p>
